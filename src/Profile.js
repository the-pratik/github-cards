...
import ProfileBackground from "./ProfileHeader.jpg";
  ...
  return (
    <>
        ...
        <div className="m-3 profile">
          ...
          <div className="mt-3" style={{ textAlign: "center" }}>
            <p className="small-text">
              {profileData.company ? `Works at 🏦 ${profileData.company}` : ""}
            </p>
            <p className="small-text">
              {profileData.company ? `Lives in 🏠 ${profileData.location}` : ""}
            </p>
            <span className="large-text">
              <a
                target="_blank"
      ...
      <div className="footer">
        Crafted with 💗 by <span className="small-text">Pratik Deshpande</span>
      </div>
    </>
  );
}
